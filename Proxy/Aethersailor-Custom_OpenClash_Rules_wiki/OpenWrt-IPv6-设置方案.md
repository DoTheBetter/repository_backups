...
> 延伸阅读：[关于“旁路由”的一些吐槽](https://github.com/Aethersailor/Custom_OpenClash_Rules/wiki/%E5%85%B3%E4%BA%8E%E2%80%9C%E6%97%81%E8%B7%AF%E7%94%B1%E2%80%9D%E7%9A%84%E4%B8%80%E4%BA%9B%E5%90%90%E6%A7%BD)
...
>
> 固定后缀也更容易被长期识别。是否采用 EUI-64，应在便于管理与隐私需求之间自行权衡；对外连接仍可由操作系统使用隐私扩展生成的临时地址。
>
...
> [!INFO]
> **关于多个 IPv6 地址**：
> 配置完成后，您可能会发现 Windows 或 iOS 设备获取了多个 IPv6 地址。这通常是现代操作系统的**隐私扩展（Privacy Extensions）**功能所致：系统可使用临时随机地址发起对外连接，同时保留基于稳定后缀生成的地址。具体选址行为由客户端操作系统决定，出现多个地址本身属于正常现象。
...
> [!WARNING]
> 为减少浏览器自身 DNS、代理或地址选择策略对结果的影响，建议先使用关闭了安全 DNS 的 Chrome/Edge 测试。Firefox 也可以使用，但应确认其 DNS over HTTPS、代理和 IPv6 相关设置没有改变系统默认链路。
...
> **一句话总结**：让 DNS 走 IPv4 通道查询，让流量走 IPv6 通道传输。这是本方案用于兼顾分流效果与网络兼容性的推荐做法。
