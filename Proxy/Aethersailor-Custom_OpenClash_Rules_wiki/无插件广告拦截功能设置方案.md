...
(
    ...
    LOG_OUT "[广告过滤规则拉取脚本] 拉取最新的 anti-AD 广告过滤规则，规则体积较大，请耐心等候…"
    curl -sSL -4 --retry 5 --retry-delay 1  "https://gcore.jsdelivr.net/gh/217heidai/adblockfilters@main/rules/adblockdns.txt" -o /tmp/dnsmasq.d/anti-ad-for-dnsmasq.conf 2> /tmp/anti-ad-curl.log
...
(
    ...
    LOG_OUT "[广告过滤规则拉取脚本] 拉取最新的 adblockfilters-modified 广告过滤规则，规则体积较大，请耐心等候…"
    mkdir -p /tmp/dnsmasq.d
    curl -sSL -4 --retry 5 --retry-delay 1 "https://github.boki.moe/https://raw.githubusercontent.com/Aethersailor/adblockfilters-modified/refs/heads/main/rules/adblockdnsmasq.txt" -o /tmp/dnsmasq.d/adblockfilters-for-dnsmasq.conf 2> /tmp/adblockfilters-modified-curl.log
