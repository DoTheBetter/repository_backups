...
>
> **推荐替代方案**：
> 建议安装 `luci-app-adblock` (搭配 `luci-i18n-adblock-zh-cn`) 或安装 `luci-app-adblock-fast` (搭配 `luci-i18n-adblock-fast-zh-cn`)。这些插件同样基于 Dnsmasq 实现拦截，但提供了更完善的 GUI 管理界面和更稳定的规则更新机制。更推荐 fast 因为更轻量化。
