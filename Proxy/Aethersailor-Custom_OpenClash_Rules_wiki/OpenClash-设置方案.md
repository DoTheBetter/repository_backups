...
在过去，yaml 文件需要自己下载导入，十分不方便，这也是本项目从创建之初一直坚持使用 luci 配置 + 订阅转换的重要原因之一。  

自 2025.8.24 起，OpenClash 最新 dev 版本 v0.46.150 已开始支持订阅远程覆写模块配置和远程 yaml 文件，本项目会推出配套的配置文件。  
...
***
如果你使用的 OpenClash 版本号为 v0.46.155 或更高版本，那么在订阅转换模板中，可直接下拉选择本项目的模板。
155之前的版本，请选择自定义模板并手动输入本项目的模板地址
...
|:-:|:-:|:-:|:-:|:-:|
|说明|标准模板⭐|轻量化模板|gfwlist 模板|重度分组模板|
|无 DNS 泄露|✅|✅|✅|✅|
|能否通过 DNS 泄露测试|✅|✅|❌|✅|
|基本国内外分流|✅|✅|❌|✅|
|gfwlist代理|✅|✅|✅|✅|
